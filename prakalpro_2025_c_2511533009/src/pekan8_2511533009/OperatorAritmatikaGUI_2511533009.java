...
public class OperatorAritmatikaGUI_2511533009 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OperatorAritmatikaGUI_2511533009 frame = new OperatorAritmatikaGUI_2511533009();
	 ...
	 * Create the frame.
	 */
	public OperatorAritmatikaGUI_2511533009() {
		setTitle("Operator Aritmatika");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 352, 275);
		...
		btnNewButton.setBounds(181, 94, 84, 20);
